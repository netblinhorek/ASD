...
TEST(TestTableAVLTree, test_unsorted_table_on_tree_empty) {
    TableAVLTree<std::string, Polynom> table_on_arr;
    ASSERT_TRUE(table_on_arr.is_empty());
}

//TEST(TestTableAVLTree, test_unsorted_table_on_arr_erase) {
//    TableAVLTree<std::string, Polynom> table_on_arr;
...
TEST(TestTableAVLTree, test_unsorted_table_on_arr_found) {
    TableAVLTree<std::string, Polynom> table_on_arr;
    Polynom p1("3x^2 + 2y - 5z + 7");
...
//TEST(TestTableAVLTree, test_unsorted_table_on_arr_found_with_erase) {
//    TableAVLTree<std::string, Polynom> table_on_arr;
//    Polynom p1("3x^2 + 2y - 5z + 7");
//    Polynom p2("3x^2 + 2y - 5z + 7");
//
...
//}
//
//TEST(TestTableAVLTree, test_unsorted_table_on_arr_found_with_throw) {
//    TableAVLTree<std::string, Polynom> table_on_arr;
//    Polynom p1("3x^2 + 2y - 5z + 7");
//    Polynom p2("3x^2 + 2y - 5z + 7");
//
...
//}
//
//TEST(TestTableAVLTree, test_insert_duplicate_key) {
...
//
//
//TEST(TestTableAVLTree, test_erase_with_throw) {
//    TableAVLTree<std::string, Polynom> table;
...
//}
//
//TEST(TestTableAVLTree, test_erase_middle_and_find_others) {
//    TableAVLTree<std::string, Polynom> table;
//    Polynom p1("10");
//    Polynom p2("20");
//    Polynom p3("30");
...
//}
//
//TEST(TestTableAVLTree, test_clear_and_reinsert) {
//    TableAVLTree<std::string, Polynom> table;
//    Polynom p1("1");
//    Polynom p2("2");
//
...
TEST(TestTableAVLTree, test_function_print) {
    TableAVLTree<std::string, Polynom> table;
    Polynom p1("3x^2 + 2y - 5z + 7");
    Polynom p2("3x^2 + 2y - 5z + 7");
...
TEST(TestTableAVLTree, test_polynom_equality) {
    TableAVLTree<Polynom, std::string> table;
    Polynom p1("3x^2 + 2y - 5z + 7");
    Polynom p2("3x^2 + 2y - 5z + 7");
    Polynom p3("x + y - z");
...
TEST(TestTableAVLTree, test_keys_stored_in_sorted_order) {
    TableAVLTree<std::string, Polynom> table;
...
TEST(TestTableAVLTree, test_found_method) {
    TableAVLTree<std::string, Polynom> table;
...
//TEST(TestTableAVLTree, test_erase_basic) {
//    TableAVLTree<std::string, Polynom> table;
//
