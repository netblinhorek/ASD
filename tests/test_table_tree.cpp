...
TEST(TestTableTree, test_unsorted_table_on_tree_empty) {
    TableTree<std::string, Polynom> table_on_tree;
    table_on_tree.print();
    ASSERT_TRUE(table_on_tree.is_empty());
}

TEST(TestTableTree, test_unsorted_table_on_tree_erase) {
    TableTree<std::string, Polynom> table_on_tree;
...
TEST(TestTableTree, test_unsorted_table_on_tree_found) {
    TableTree<std::string, Polynom> table_on_tree;
    Polynom p1("3x^2 + 2y - 5z + 7");
    Polynom p2("3x^2 + 2y - 5z + 7");
...
TEST(TestTableTree, test_unsorted_table_on_tree_found_with_erase) {
    TableTree<std::string, Polynom> table_on_tree;
    Polynom p1("3x^2 + 2y - 5z + 7");
    Polynom p2("3x^2 + 2y - 5z + 7");
...
TEST(TestTableTree, test_unsorted_table_on_tree_found_with_throw) {
    TableTree<std::string, Polynom> table_on_tree;
    Polynom p1("3x^2 + 2y - 5z + 7");
    Polynom p2("3x^2 + 2y - 5z + 7");
...
TEST(TestTableTree, test_insert_duplicate_key) {
    TableTree<std::string, Polynom> table;
    Polynom p1("x+y");
    Polynom p2("z");
...
TEST(TestTableTree, test_erase_with_throw) {
    TableTree<std::string, Polynom> table;
    ASSERT_THROW(table.erase("pol1"), std::out_of_range);
    Polynom p("x");
}

TEST(TestTableTree, test_erase_middle_and_find_others) {
    TableTree<std::string, Polynom> table;
    Polynom p1("10");
    Polynom p2("20");
    Polynom p3("30");
...
TEST(TestTableTree, test_clear_and_reinsert) {
    TableTree<std::string, Polynom> table;
    Polynom p1("1");
    Polynom p2("2");
...
TEST(TestTableTree, test_function_print) {
    TableTree<std::string, Polynom> table;
    Polynom p1("3x^2 + 2y - 5z + 7");
    Polynom p2("3x^2 + 2y - 5z + 7");
...
TEST(TestTableTree, test_polynom_equality) {
    TableTree<Polynom, std::string> table;
    Polynom p1("3x^2 + 2y - 5z + 7");
    Polynom p2("3x^2 + 2y - 5z + 7");
    Polynom p3("x + y - z");
...
TEST(TestTableTree, test_operator_bracket_simple) {
    TableTree<std::string, Polynom> table;
