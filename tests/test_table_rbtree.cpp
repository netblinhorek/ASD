...
TEST(TestTableRBTree, test_unsorted_table_on_tree_empty) {
    TableRBTree<std::string, Polynom> table_on_arr;
    ASSERT_TRUE(table_on_arr.is_empty());
}

TEST(TestTableRBTree, test_unsorted_table_on_arr_erase) {
    TableRBTree<std::string, Polynom> table_on_arr;
...
TEST(TestTableRBTree, test_unsorted_table_on_arr_found) {
    TableRBTree<std::string, Polynom> table_on_arr;
    Polynom p1("3x^2 + 2y - 5z + 7");
...
TEST(TestTableRBTree, test_unsorted_table_on_arr_found_with_erase) {
    TableRBTree<std::string, Polynom> table_on_arr;
    Polynom p1("3x^2 + 2y - 5z + 7");
    Polynom p2("3x^2 + 2y - 5z + 7");
...
TEST(TestTableRBTree, test_unsorted_table_on_arr_found_with_throw) {
    TableRBTree<std::string, Polynom> table_on_arr;
    Polynom p1("3x^2 + 2y - 5z + 7");
    Polynom p2("3x^2 + 2y - 5z + 7");
...
TEST(TestTableRBTree, test_insert_duplicate_key) {
    TableRBTree<std::string, Polynom> table;
    Polynom p1("x+y");
    Polynom p2("z");
...
TEST(TestTableRBTree, test_erase_with_throw) {
    TableRBTree<std::string, Polynom> table;
...
TEST(TestTableRBTree, test_erase_middle_and_find_others) {
    TableRBTree<std::string, Polynom> table;
    Polynom p1("10");
    Polynom p2("20");
    Polynom p3("30");
...
TEST(TestTableRBTree, test_clear_and_reinsert) {
    TableRBTree<std::string, Polynom> table;
    Polynom p1("1");
    Polynom p2("2");
...
TEST(TestTableRBTree, test_function_print) {
    TableRBTree<std::string, Polynom> table;
    Polynom p1("3x^2 + 2y - 5z + 7");
    Polynom p2("3x^2 + 2y - 5z + 7");
...
TEST(TestTableRBTree, test_polynom_equality) {
    TableRBTree<Polynom, std::string> table;
    Polynom p1("3x^2 + 2y - 5z + 7");
    Polynom p2("3x^2 + 2y - 5z + 7");
    Polynom p3("x + y - z");
...
TEST(TestTableRBTree, test_keys_stored_in_sorted_order) {
    TableRBTree<std::string, Polynom> table;
...
TEST(TestTableRBTree, test_found_method) {
    TableRBTree<std::string, Polynom> table;
...
TEST(TestTableRBTree, test_erase_basic) {
    TableRBTree<std::string, Polynom> table;
